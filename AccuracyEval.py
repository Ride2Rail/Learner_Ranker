...
class ACC_EVAL:
    ...
    def csv_Analysis(self,filename='AccEvalResult.csv',filepath=None):
        ...
        labels=['KNN','SVC','DecisionTree','LogisticRegression','RandomForest'] #,'BEST_Acc']

        plt.boxplot(data_Box,labels=labels)
        plt.xlabel('Classifiers')
        plt.ylabel('Accuracy')
        plt.title('Accuracy Boxplot of Different Algorithms')
        plt.show()
        ...
        best_labels=['BEST_Classifier']

        plt.boxplot(best_Box,labels=best_labels)
        # plt.xlabel('Classifiers')
        plt.ylabel('Accuracy') 
        plt.title('Accuracy Boxplot of the Best Model')
        plt.show()
        ...
        plt.title('The proportion of different algorithms that are used to generate the best model.')
        plt.show()
        ...
        time_labels=['KNN','SVC','DecisionTree','Logistic Regression','Random Forest'] #,'BEST_trainingtime']

        plt.boxplot(time_Box,labels=time_labels)
        plt.xlabel('Classifiers')
        plt.ylabel('Training time (Seconds)')
        plt.title('Training time Boxplot of Different Algorithms')
        plt.show() 
        ...
        plt.ylabel('Training time (Seconds)')
        plt.title('Total Training Time Boxplot')
        plt.show()
